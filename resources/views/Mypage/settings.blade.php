            ...
            <div class="m-auto" style="max-width:600px;">
                <div class="mb-5">
                    ...
                    <div class="card card-body  border-2">
                        ...
                        >
                            @csrf
                            {{asset('storage/'. Auth::user()->image_puth)}}
                            <!-- 氏名 -->
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="" style="width:200px">
                                    <read-image-file-component img_path="{{asset('storage/'.Auth::user()->image_puth)}}" alt="アイコン画像"/>
                                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="card card-body  border-2">
                        ...
                        <div class="">
                            <a href="{{route('user_auth.reset_pass_form')}}" class="text-primary">パスワードの変更はこちら</a>
                        </div>
                    </div>
